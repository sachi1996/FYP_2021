...
character_data = ['r', 'm', 'o', 'p', 'r', 'h', 'm', 'l', 'm', 'r', 'p', 'l',
                  'o', 'p', 'r', 'm', 'p', 'l', 'm', 'r', 'o', 'l',
                  'p', 'r', 'm', 'o', 'l', 'p', 'm', 'r', 'o', 'h', 'o', 'p', 'h']


labels = [23, 20, 0, 22, 23, 17, 20, 19, 20, 23, 22, 19,
          0, 22, 23, 20, 22, 19, 20, 23, 0, 19,
          22, 23, 20, 0, 19, 22, 20, 23, 0, 17, 0, 22, 17]
...
filename = "F:/Python/OpenCV/B_Post_Processing/rmophl.csv"
